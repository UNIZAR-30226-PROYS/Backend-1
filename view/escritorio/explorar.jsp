                            ...
                            <div class="col-3 h-100 align-content-center align-items-center">
                                <a href="/list?id=${lista.getIdLista()}" target="_self">
                                    <div class="img-thumbnail h-100">
                                        ...
                                        " alt="Imagen lista" class="pt-3" style="max-width:100%;max-height:78px">
                            ...
                            <div class="col-3 h-100 align-content-center align-items-center">
                                <div class="img-thumbnail h-100">
                                    <a href="/song?id=${audio.getIdCancion()}" target="_self">
                                        <img src="${pageContext.request.contextPath}/contenido/imagenes/canciones/${audio.getIdCancion()}.png" class="pt-3" alt="" style="max-width:100%;max-height:78px;">
                                        <div class="caption pt-3 pb-2">
