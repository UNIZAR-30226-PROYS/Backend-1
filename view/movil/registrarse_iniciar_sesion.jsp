			...
			<div class="tab-content" id="myTabContent"> 		<!-- Sino aparece uno debajo de otro -->
				...
				<div class="tab-pane fade" 	id="registrarse" role="tabpanel" aria-labelledby="registrarse-tab">
					...
					<form class="needs-validation" action="register" method="post" novalidate>
						...
						<div class="form-group">
							<label for="nombre_usuario">Nombre de usuario</label>
							<input type="text" class="form-control" id="nombre_usuario_reg" name="user" placeholder="usuario_123" required>
							<div class="invalid-feedback"> No puedes dejar este campo en blanco. </div>
						</div>
						
						<div class="form-group">
							<label for="contrasenya">Contraseña</label>
							<input type="password" class="form-control" id="contrasenya_reg" name="pass" placeholder="*****" required>
							<div class="invalid-feedback"> No puedes dejar este campo en blanco. </div>
						</div>
						
						<div class="form-group">
							<label for="confirmar_contrasenya"> Confirmar Contraseña</label>
							<input type="password" class="form-control" id="confirmar_contrasenya" name="confirm_pass" placeholder="*****" required>
							<div class="invalid-feedback"> No puedes dejar este campo en blanco. </div>
						</div>

						<div class="form-group">
							<label for="correo">Direccion de correo</label>
							<input type="email" class="form-control" id="correo" name="email" placeholder="user@mail .." required>
							<div class="invalid-feedback"> No puedes dejar este campo en blanco. </div>
						</div>
